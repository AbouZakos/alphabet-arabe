...
export const metadata: Metadata = {
  title: 'Alphabet arabe : apprendre les 28 lettres facilement',
  description: 'Apprenez l\'alphabet arabe gratuitement : les 28 lettres avec prononciation, PDF à imprimer et exercices pour débutants. Guide complet en français.',
  alternates: { canonical: 'https://alphabet-arabe.com' },
  openGraph: {
    title:       'Alphabet arabe : apprendre les 28 lettres facilement',
    description: 'Guide complet pour apprendre l\'alphabet arabe. 28 lettres, prononciation, PDF gratuit.',
